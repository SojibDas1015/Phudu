...
const Hero = () => {
    return (
        <div className='max-w-[1281px] mx-auto px-2 md:px-10 py-6'>
            <div className='space-y-4 border-2 border-white rounded-3xl p-2 md:py-10 bg-linear-to-t from-white to-white/0'>
                <h1 className='font-extrabold text-2xl md:text-5xl text-center max-w-[917px] mx-auto'>Dependable Care, Backed by Trusted Professionals.</h1>
                ...
                <div className="join flex gap-4 justify-center">
                    <div>
                        <label className="input validator join-item rounded-full md:w-[600px]">
                ...
                <div className='md:flex items-center justify-center gap-6'>
                    <img className='pb-3 md:p-0' width={478} src={bannerImage} alt="" />
